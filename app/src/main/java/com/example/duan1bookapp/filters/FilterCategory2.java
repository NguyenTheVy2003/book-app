...
public class FilterCategory2 extends Filter {
    //arraylist in which filter we want to search
    ArrayList<ModelCategory2> filterList;
    //adapter in which filter need to be implemented
    AdapterCategory2 adapterCategory;

    //constructor
    public FilterCategory2(ArrayList<ModelCategory2> filterList, AdapterCategory2 adapterCategory) {
    ...
    protected FilterResults performFiltering(CharSequence constraint) {
        ...
        if (constraint != null && constraint.length() > 0) {
            ...
            ArrayList<ModelCategory2> filterModels = new ArrayList<>();
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        //apply filter
        adapterCategory.categoryArrayList = (ArrayList<ModelCategory2>) results.values;
